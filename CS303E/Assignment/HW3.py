...
while secret_num != user_answer and user_answer != 0:
    if user_answer < secret_num and user_answer >= 1:
            total_guess += 1
            print("Your guess is too low.")
    elif user_answer > secret_num and user_answer <= 1000:
            total_guess += 1
            print("Your guess is too high.")
# prevent user entering numbers outside from the 1 to 1000 range          
    else:
            total_guess += 1
